...
namespace WebShopAPI.Migrations
{
    ...
    [Migration("20240917042109_Review_Imgpro")]
    partial class Review_Imgpro
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebShopAPI.Data.ImgPro", b =>
                {
                    ...
                    b.Property<string>("IdProNavigationIdPro")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebShopAPI.Data.Review", b =>
                {
                    ...
                    b.Property<string>("IdAccNavigationId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebShopAPI.Data.ImgPro", b =>
                {
                    b.HasOne("WebShopAPI.Data.Product", "IdProNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("WebShopAPI.Data.Review", b =>
                {
                    b.HasOne("WebShopAPI.Data.AppUser", "IdAccNavigation")
                        .WithMany()
                        .HasForeignKey("IdAccNavigationId");

                    b.HasOne("WebShopAPI.Data.Product", "IdProNavigation")
                        .WithMany()
                        .HasForeignKey("IdProNavigationIdPro");

                    b.Navigation("IdAccNavigation");
